...
public class SignUpFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        userViewModel.getIsDataSaved().observe(getViewLifecycleOwner(), userModelMessageResult -> {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        signUpBtn.setOnClickListener(v -> {
            ...
            if (!email.isEmpty() && !pass.isEmpty()) {
                ...
                userViewModel.signUp(new UserModel(email, pass));

            } else {
                Toast.makeText(getContext(), "Please Enter Name, Email and Pass", Toast.LENGTH_SHORT).show();
            }
        });
    }
